...
Endpoints:
    ...
    GET  /api/status    — Lightweight probe of model availability
    GET  /api/champions — Return champion list with role data
    POST /api/recommend — Get top-5 recommendations for current draft step
    POST /api/evaluate  — Final win prob for a completed 5v5 composition
    GET  /api/analysis  — Champion analytics (synergy/counter/role splits)
"""
